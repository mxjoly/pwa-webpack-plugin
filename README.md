...
Add some keys (name of the file that will be generated) to the categories to generate new icons. These keys must have as values an object with the following properties:

| Properties    | Type       | Description                                      |
| ------------- | ---------- | ------------------------------------------------ |
| `width`       | `number`   | The width of the icon.                           |
| `height`      | `number`   | The height of the icon.                          |
| `dwidth`      | `number`   | The screen width (for apple devices).            |
| `dheight`     | `number`   | The screen height (for apple devices).           |
| `ratio`       | `number`   | The pixel ratio of the screen.                   |
| `rel`         | `number`   | The value of the rel attribute for the html tag. |
