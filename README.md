...
You can configure the icons that will be generated by creating `icons.json` at the root of your project with the schema defined in `lib/schema.json`. The following table figure out the different properties pf the image configuration:
...
| `transparent` | `boolean`  | Set the bakcground transparent.                  |
